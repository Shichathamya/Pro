...
EDA_Plant2.py
=============
Exploratory Data Analysis for Plant 2 Solar Power Generation
"""
...
df = pd.read_csv(os.path.join(DATASET_DIR, "Plant_2_Joined.csv"))
...
fig1.suptitle("Plant 2 — Solar Power Generation Overview",
...
fig1.savefig(os.path.join(OUTPUT_DIR, "EDA_P2_01_Overview.png"),
             dpi=150, bbox_inches="tight")
plt.close(fig1)
print("  [Saved] EDA_P2_01_Overview.png")
...
fig2.suptitle("Plant 2 — Inverter Performance Analysis",
              fontsize=16, fontweight="bold", y=0.98)
...
fig2.savefig(os.path.join(OUTPUT_DIR, "EDA_P2_02_Inverter.png"),
             dpi=150, bbox_inches="tight")
plt.close(fig2)
print("  [Saved] EDA_P2_02_Inverter.png")
...
fig3.suptitle("Plant 2 — Time Series Analysis",
              fontsize=16, fontweight="bold", y=0.98)
...
plt.tight_layout()
fig3.savefig(os.path.join(OUTPUT_DIR, "EDA_P2_03_TimeSeries.png"),
             dpi=150, bbox_inches="tight")
plt.close(fig3)
print("  [Saved] EDA_P2_03_TimeSeries.png")
